...
export default function SubscribePage() {
  ...
  const handleSignOut = async () => {
    try {
      ...
      router.push('/login'); // ALWAYS redirect, no matter what
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4 relative">
      ...
      <button
        ...
        className="absolute top-4 right-4 bg-gray-700 hover:bg-gray-600 text-white px-4 py-2 rounded-3xl font-semibold transition-colors"
      >
        Logout
      </button>
      ...
      <div className="bg-gray-800 rounded-2xl p-8 max-w-md w-full">
        ...
        <p className="text-gray-400 text-center mb-8">
          Unlock unlimited question generation
        </p>

        {/* Pricing Card */}
        <div className="bg-gray-700 rounded-2xl shadow-lg p-6 mb-6">
